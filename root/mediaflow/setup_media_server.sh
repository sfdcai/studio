...
# This allows for live monitoring of rclone uploads via http://localhost:5572
...
echo "3. Run 'rclone config' to set up your cloud storage remote (e.g., name it 'gdrive')."
...
echo "6. You can access the rclone web UI by forwarding port 5572 from your server."
